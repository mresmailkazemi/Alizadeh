        ...
        config: {
            ...
            glyphicons: {
                icons: {
                    ...
                    next: '<span class="glyphicon glyphicon-modelmessage"></span>',
                    last: '<span class="glyphicon glyphicon-step-modelmessage"></span>',
            ...
            fontawesome: {
                icons: {
                    ...
                    next: '<i class="fa fa-modelmessage" aria-hidden="true"></i>',
                    last: '<i class="fa fa-fast-modelmessage" aria-hidden="true"></i>',
